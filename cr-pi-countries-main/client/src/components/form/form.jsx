...
const Form = () => {
    ...
    const handleCreate = async(event) => {
        ...
        event.preventDefault()
        setCountriesSelect((prevCountries) => prevCountries.filter((element) => element[0] !== id))
    }
        ...
        {stateError?
            ...
            <div className={styles.container}>
                ...
                <form className={styles.form} onSubmit={handleCreate}>
                    ...
                    <div>
                        <button type="submit" className={styles.btn} disabled={Object.entries(error).length > 0}  >
                            <span className={styles.front} hidden={Object.entries(error).length > 0}>Create</span>
                        </button>
                    </div>
                </form>
            </div>
